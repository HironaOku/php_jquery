...
<head>
	...
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
 	...
 	<link rel="stylesheet" type="text/css" href="../css/my_timetable.css">
</head>
<body>		
    ...
    <div id="myTableconteiner">
    	...
    	<a href="my_timetable.php?searchSem=1"><button type="button" class="btn btn-secondary btn-sm btnWithdrw">Semester 1</button></a>
    	<a href="my_timetable.php?searchSem=2"><button type="button" class="btn btn-secondary btn-sm btnWithdrw">Semester 2</button></a>
    	<a href="my_timetable.php?searchSem=3"><button type="button" class="btn btn-secondary btn-sm btnWithdrw">Winter School</button></a>
    	<a href="my_timetable.php?searchSem=4"><button type="button" class="btn btn-secondary btn-sm btnWithdrw">Spring School</button></a>
